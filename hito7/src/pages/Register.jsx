...
const Register = () => {
    ...
    const handleSubmit = (event) => {
        ...
        if (newFormState.isValid) {
            handleShow({title: "Registro exitoso!", text: "Los datos ingresados son correctos.", ok: true});
        } else {
    ...
    const handleClose = () => {
        ...
        if (modalState.ok) actions.login(formState.inputs.email.value, formState.inputs.password1.value);
    }
